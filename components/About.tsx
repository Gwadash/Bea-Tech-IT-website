    ...
    <section id="about" className="py-20 bg-white scroll-mt-20">
      <div ref={sectionRef} className={`container mx-auto px-4 sm:px-6 lg:px-8 ${isVisible ? 'is-visible' : ''}`}>
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="text-left animate-on-scroll slide-up">
            ...
            <div className="flex items-center justify-center lg:order-last order-first animate-on-scroll slide-up" style={{ transitionDelay: '150ms' }}>
                <img 
